...
@WebServlet(name = "MahmoudImageServlet", urlPatterns = { "/mahmoudimageservlet" })
public class MahmoudImageServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement statement =
                conn.prepareStatement("SELECT ATTACHED_FILE FROM EMPLOYEE_ATTACHMENTS where EMP_ATTACHMENT_ID= ? and ATTACHMENT_TYPE = 1 ");
